    ...
    processUserInput(input) {
        ...
        if (chatbotConfig.aiPredictionKeywords.some(keyword => lowerInput.includes(keyword))) {
            ...
            this.addMessage(`
                <div class="chatbot-buttons-container">
                    <button class="chatbot-nav-button" onclick="window.location.href='https://navcancer-ai-prediction.ktripathi.site/'">Open AI Prediction Tool</button>
        ...
        const responses = [
            ...
            },
            {
                ...
                action: () => {
                    window.open('https://navcancer-ai-prediction.ktripathi.site/', '_blank');
                },
                matchType: 'every'
            },
            {
